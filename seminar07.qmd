...
- Discuss lab 5 at Wed workshop.
- Discuss worksheet 6 at Thu workshop.
- Discuss next week's Mock exam.


## `r fa("compass")` Outline of today

1. Quick return to worksheet 5 
...
- Completing all components (worksheets, labs, reading)
...
- (.2) variability due to all other factors (within group var -- nuisance factor)
:::

## Salary data : hypothesis test {.smaller}

$H_0 : \text{the average salary is the same across all nations}$ ($\mu_{S} = \mu_{E} = \mu_{NI} = \mu_{W}$)
...
<!-- Having nothing here causes a render/pandoc/tex error. Adding this commented piece fixes it..!?  -->
:::
